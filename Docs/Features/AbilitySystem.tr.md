...
- Dash executor shape-cast tabanli collision check kullaniyor.
...
- Interaction demo'su tek receiver ile sade tutuldu (`DummyAbilityTarget`).
- Visual karar ability tarafindan `AbilityVisualCommand` ile verilir; receiver sadece uygular.
